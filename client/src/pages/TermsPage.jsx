    ...
    >
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px 64px' }}>
        ...
        <div style={sectionStyle}>
          <div style={headingStyle}>一、平台宗旨</div>
        ...
        {/* 第二章 */}
        <div style={sectionStyle}>
          <div style={headingStyle}>二、账号注册与使用</div>
          <p style={paragraphStyle}>
        ...
        {/* 第三章 */}
        <div style={sectionStyle}>
          <div style={headingStyle}>三、内容版权与知识产权</div>
          <p style={paragraphStyle}>
        ...
        {/* 第四章 */}
        <div style={sectionStyle}>
          <div style={headingStyle}>四、用户行为规范</div>
          <p style={paragraphStyle}>
        ...
        {/* 第五章 */}
        <div style={sectionStyle}>
          <div style={headingStyle}>五、免责声明</div>
          <p style={paragraphStyle}>
        ...
        {/* 第六章 */}
        <div style={sectionStyle}>
          <div style={headingStyle}>六、协议变更</div>
          <p style={paragraphStyle}>
        ...
        {/* 第七章 */}
        <div style={sectionStyle}>
          <div style={headingStyle}>七、联系我们</div>
          <p style={paragraphStyle}>
