    ...
    >
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px 64px' }}>
        ...
        <div style={sectionBaseStyle}>
          <div style={headingBaseStyle}>一、信息收集范围</div>
        ...
        {/* 第二章 */}
        <div style={sectionBaseStyle}>
          <div style={headingBaseStyle}>二、信息使用目的</div>
          <p style={paragraphBaseStyle}>
        ...
        {/* 第三章 */}
        <div style={sectionBaseStyle}>
          <div style={headingBaseStyle}>三、信息存储与安全</div>
          <p style={paragraphBaseStyle}>
        ...
        {/* 第四章 */}
        <div style={sectionBaseStyle}>
          <div style={headingBaseStyle}>四、信息共享与披露</div>
          <p style={paragraphBaseStyle}>
        ...
        {/* 第五章 */}
        <div style={sectionBaseStyle}>
          <div style={headingBaseStyle}>五、Cookie 与本地存储</div>
          <p style={paragraphBaseStyle}>
        ...
        {/* 第六章 */}
        <div style={sectionBaseStyle}>
          <div style={headingBaseStyle}>六、用户权利</div>
          <p style={paragraphBaseStyle}>
        ...
        {/* 第七章 */}
        <div style={sectionBaseStyle}>
          <div style={headingBaseStyle}>七、政策更新</div>
          <p style={paragraphBaseStyle}>
        ...
        {/* 第八章 */}
        <div style={sectionBaseStyle}>
          <div style={headingBaseStyle}>八、联系我们</div>
          <p style={paragraphBaseStyle}>
